...
public class mainteste2 {
   ...
   private static void registrarFrequencia(ServicoFrequencia servicoFrequencia, Scanner scanner) {
	    ...
	    try {
	        ...
	        System.out.print("O aluno esteve presente? (sim ou não): ");
	        ...
	        if (resposta.equals("sim")) {
	            ...
	            return; // Retorna ao menu sem continuar
	        }

	 

	        // Registra a frequência utilizando o serviço de frequência
	        servicoFrequencia.adicionar( 0, data, presente);
